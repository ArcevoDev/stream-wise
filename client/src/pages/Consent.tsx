  ...
  if (checking) {
    return (
      <div className="min-h-[calc(100vh-56px)] flex items-center justify-center">
        <GeneratedIcon name="loader-circle" size={20} className="animate-spin text-muted-foreground" />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-8 sm:py-10">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <GeneratedIcon name="shield-check" size={28} className="mx-auto text-primary mb-3" />
