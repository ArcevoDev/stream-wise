...
export default function ConsentLanding() {
  ...
  const hero = (
    <div className="mx-auto flex min-h-[auto] w-full max-w-5xl flex-col items-center justify-center px-4 text-center py-6 lg:min-h-[calc(100vh-20rem)]">
      ...
      <div className="mx-auto mt-10 grid w-full max-w-3xl grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
        {WHY_POINTS.map((s) => (
