// Load the fixed nft bundle the way Lambda does: require the zip's root
// entry and check the handler is exported.
...
const zipPath = join(process.cwd(), ".netlify/functions-js2/api.zip");
const dest = join(tmpdir(), "zisi-load-fixed");
